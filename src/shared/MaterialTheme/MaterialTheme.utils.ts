...
export function applyMaterialTheme(
	scheme: { light: MaterialScheme; dark: MaterialScheme; neutral: TonalPalette },
	...
	const cssVariables = [
		[`--md-sys-color-background`, baseScheme.background],
		[`--md-sys-color-error`, baseScheme.error],
		[`--md-sys-color-error-container`, baseScheme.errorContainer],
		[`--md-sys-color-inverse-on-surface`, baseScheme.inverseOnSurface],
		[`--md-sys-color-inverse-primary`, baseScheme.inversePrimary],
		[`--md-sys-color-inverse-surface`, baseScheme.inverseSurface],
		[`--md-sys-color-on-background`, baseScheme.onBackground],
		[`--md-sys-color-on-error`, baseScheme.onError],
		[`--md-sys-color-on-error-container`, baseScheme.onErrorContainer],
		[`--md-sys-color-on-primary`, baseScheme.onPrimary],
		[`--md-sys-color-on-primary-container`, baseScheme.onPrimaryContainer],
		[`--md-sys-color-on-primary-fixed`, baseScheme.onPrimaryFixed],
		[`--md-sys-color-on-primary-fixed-variant`, baseScheme.onPrimaryFixedVariant],
		[`--md-sys-color-on-secondary`, baseScheme.onSecondary],
		[`--md-sys-color-on-secondary-container`, baseScheme.onSecondaryContainer],
		[`--md-sys-color-on-secondary-fixed`, baseScheme.onSecondaryFixed],
		[`--md-sys-color-on-secondary-fixed-variant`, baseScheme.onSecondaryFixedVariant],
		[`--md-sys-color-on-surface`, baseScheme.onSurface],
		[`--md-sys-color-on-surface-variant`, baseScheme.onSurfaceVariant],
		[`--md-sys-color-on-tertiary`, baseScheme.onTertiary],
		[`--md-sys-color-on-tertiary-container`, baseScheme.onTertiaryContainer],
		[`--md-sys-color-on-tertiary-fixed`, baseScheme.onTertiaryFixed],
		[`--md-sys-color-on-tertiary-fixed-variant`, baseScheme.onTertiaryFixedVariant],
		[`--md-sys-color-outline`, baseScheme.outline],
		[`--md-sys-color-outline-variant`, baseScheme.outlineVariant],
		[`--md-sys-color-primary`, baseScheme.primary],
		[`--md-sys-color-primary-container`, baseScheme.primaryContainer],
		[`--md-sys-color-primary-fixed`, baseScheme.primaryFixed],
		[`--md-sys-color-primary-fixed-dim`, baseScheme.primaryFixedDim],
		[`--md-sys-color-scrim`, baseScheme.scrim],
		[`--md-sys-color-secondary`, baseScheme.secondary],
		[`--md-sys-color-secondary-container`, baseScheme.secondaryContainer],
		[`--md-sys-color-secondary-fixed`, baseScheme.secondaryFixed],
		[`--md-sys-color-secondary-fixed-dim`, baseScheme.secondaryFixedDim],
		[`--md-sys-color-shadow`, baseScheme.shadow],
		[`--md-sys-color-source-color`, "#ee715a"], // фиксированное значение
		[`--md-sys-color-surface`, baseScheme.surface],
		[`--md-sys-color-surface-bright`, hexFromArgb(scheme.neutral.tone(type === "light" ? 24 : 27))], // подогнано под #423735
		[
		...
		[`--md-sys-color-surface-dim`, hexFromArgb(scheme.neutral.tone(type === "light" ? 6 : 6))], // подогнано под #1a1110
		[`--md-sys-color-surface-tint`, baseScheme.surfaceTint],
		[`--md-sys-color-surface-variant`, baseScheme.surfaceVariant],
		[`--md-sys-color-tertiary`, baseScheme.tertiary],
		[`--md-sys-color-tertiary-container`, baseScheme.tertiaryContainer],
		[`--md-sys-color-tertiary-fixed`, baseScheme.tertiaryFixed],
		[`--md-sys-color-tertiary-fixed-dim`, baseScheme.tertiaryFixedDim],
	]
